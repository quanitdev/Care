        ...
        <div class="wrap-form">
            <div class="search-form">
                <form action="SearchServlet" class="w-full" method="get">
                    ...
                    <div class="form-control flex items-center ralative w-full">
                        ...
                        <input name="keyword" placeholder="Search..." type="text"
                               class="search-input w-full bg-while border-[1px] rounded-[30px] h-[40px] border-[#b3b3b3] p1-[40px]">
                    </div>
                </form>
            </div>
        </div>
        ...
        <section id="product1" class="section-p1">
            <div class="row">
                <form action="CategoryServlet" class="filter" method="get">
                    ...
                    <button type="submit" class="filter-submit btn-primary">Filter</button>
                </form>
            </div>
